...
//  angle = v1.Angle(v2);
  ...
  if(protonEnergy > 7.4 && protonEnergy < 9.7) {
    protonEnergy = rng->Uniform(7.4, 9.7);
  }
  protonEnergy = protonMethane->AddBack(protonEnergy, 250);
...
void Spectra::ReadSolidAngle() {
  ...
  // std::ifstream inReg1("csReg1_Corrected.out");
